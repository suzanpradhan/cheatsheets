...
import { Paper, Stack, Group, Button, TextInput, Textarea, Select, Text } from '@mantine/core';
...
export const NewSnippetButton = ({onAdd}: NewSnippetProps) => {
    ...
    return (
            <Paper shadow="sm" withBorder radius="md" className={"max-w-3xl mx-auto mb-12 "}>
                <Stack gap="xs">
                    <Group gap="xs" style={{ borderBottom: '1px solid var(--mantine-color-gray-3)' }} px={"lg"} py={"xs"}>
                    ...
                    {isExpanded && (
                        <>
                            ...
                            <Group justify="space-between" align="center" p={"sm"}>
                                ...
                                <Group>
                                    <Button variant="subtle" color="gray" onClick={handleDismiss} size="xs">
                                        Dismiss
                                    </Button>
